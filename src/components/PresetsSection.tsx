...
const presets = [
  { name: "Snakes", image: presetSnakes },
  { name: "Terracotta", image: presetTerracotta },
  { name: "Cobalt Float", image: presetCobalt },
  { name: "Stone Ledge", image: presetStone },
  { name: "Centella", image: presetCentella },
  { name: "Snakes", image: presetSnakes },
  { name: "Terracotta", image: presetTerracotta },
  { name: "Cobalt Float", image: presetCobalt },
  { name: "Stone Ledge", image: presetStone },
    ...
    <section className="py-24 overflow-hidden">
      <div className="px-4 max-w-6xl mx-auto mb-8">
        <h2 className="text-3xl md:text-5xl font-medium text-foreground mb-4 text-center">
          Create faster with presets
        </h2>
        <p className="text-muted-foreground text-center max-w-lg mx-auto mb-2">
          One-click styles designed for your industry. From studio clean to editorial drama.
        </p>
        <p className="text-center">
          <a href="#" className="text-sm text-primary hover:underline">Browse presets →</a>
        </p>
      </div>
